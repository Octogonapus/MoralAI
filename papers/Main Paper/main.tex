...
We approach technology as a social issue. How do I think about society and myself? How do I
imagine other AI engineers? How should they respond to this? What is and what ought to be?

AI researchers in this position have a responsibility to address this problem.
What responsibilities do AI researchers have to address these problems?

Lay out ways in which different AI's have different effects on peoples lives.
Discuss the conclusions of these AI's. There are many ways in which AI can go wrong.
Identifying bias is only possible to people who are informed by ethical concerns.
How do we fix it? Fixing this is a moral act.

Cite robot ethics 2.0.
