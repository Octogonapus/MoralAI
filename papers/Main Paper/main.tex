...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_40-60_100-0_0-100_accuracy_contour_plot.png}
    \caption[]{The classification accuracy against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_40-60_100-0_0-100_accuracy_contour_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_40-60_100-0_0-100_accuracy_surface_plot.png}
    \caption[]{The classification accuracy against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_40-60_100-0_0-100_accuracy_surface_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_40-60_100-0_0-100_loss_contour_plot.png}
    \caption[]{The loss against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_40-60_100-0_0-100_loss_contour_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_40-60_100-0_0-100_loss_surface_plot.png}
    \caption[]{The loss against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_40-60_100-0_0-100_loss_surface_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_50-50_50-50_50-50_accuracy_contour_plot.png}
    \caption[]{The classification accuracy against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_50-50_50-50_50-50_accuracy_contour_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_50-50_50-50_50-50_accuracy_surface_plot.png}
    \caption[]{The classification accuracy against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_50-50_50-50_50-50_accuracy_surface_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_50-50_50-50_50-50_loss_contour_plot.png}
    \caption[]{The loss against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_50-50_50-50_50-50_loss_contour_plot}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{test_50-50_50-50_50-50_loss_surface_plot.png}
    \caption[]{The loss against \code{test 40-60 100-0 0-100}.}
    \label{fig:test_50-50_50-50_50-50_loss_surface_plot}
\end{figure}
